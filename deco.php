...
<?php include("sp_header.php");?>
	...
	<aside id="sidebar">
		<section>
			<div class="clear">
				<img src="images/Dream_Catcher.jpg" alt="Decorations" >
			</div>
		</section>
	...
	<div id="caption">
		<section>
			<h2>Description</h2>
			<p>This dream catcher is made for any large wall - also looks nice in replacement as a head board. Made from items found in nature.
			</p><br>
			<h2>$150.00</h2>
