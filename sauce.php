...
<?php include("sp_header.php");?>
	...
	<aside id="sidebar">
		<section>
			<div class="clear">
				<img src="images/Camellia_Honey.jpg" alt="Camellia Honey" >
			</div>
		</section>

		<div class="product_details">
			<h4>Flavors:</h4>
			<p>Camellias and Gugar flowers</p>
			<h4>Weight and volume:</h4>
			<p>750g/ Diameter 7.5cm x High 19cm</p>
			<h4>Manufacturer:</h4>
			<p>Green In Hand</p>
		</div>
	</aside>
	...
	<div id="caption">
		<section>
			<h2>Description</h2>
			<p>Made with 100% naturally matured camellia honey from Nantou, Taiwan. 
			</p><br>
			<h2>$12.99</h2>
